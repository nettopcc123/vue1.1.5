...
　　},
    $route(to,from){
        if(to.path == '/' || to.path == '/member'){ //用户中心
            this.ish80 = true;
        }else{
            this.ish80 = false;
        }
...
@font-face {
  ...
  src: url('//at.alicdn.com/t/font_880675_nweopqb2kpd.eot');
  src: url('//at.alicdn.com/t/font_880675_nweopqb2kpd.eot?#iefix') format('embedded-opentype'),
  url('//at.alicdn.com/t/font_880675_nweopqb2kpd.woff') format('woff'),
  url('//at.alicdn.com/t/font_880675_nweopqb2kpd.ttf') format('truetype'),
  url('//at.alicdn.com/t/font_880675_nweopqb2kpd.svg#iconfont') format('svg');
}
.iconfont {
