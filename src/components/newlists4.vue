  ...
  <div class="newlists" id="newlists">
        <ul class="nlist">
            <li v-for="(value, key) in newList" v-if="key <= 1">
                ...
                <span class="nimg_a"><img :src="require('./../components/img/ban/d/' + value.Image +'.jpg')"></span>
...
import newban4 from './../components/new_h04';
