...
<template>
  <div class="newlists" id="newlists" scoped>
        <ul class="nlist p0">
            <li v-for="(value, key) in newList" v-if="key == 0">
                ...
                <span class="nimg_c"><img :src="require('./../components/img/lq.jpg')"></span>
                <span class="newsCtn_c">
                    <h2 class="ntit hauto">{{ value.Title | filter | restr }}</h2>
        ...
        <ul class="nlist">
            <li v-for="(value, key) in newList" v-if="key == 1">
                <router-link :to="{ name: 'newsMore1', params: { articid: value.Id , page: num, content: value.Content}}">
                <span class="nimg_b"><img :src="require('./../components/img/ban/h/' + value.Image +'.jpg')"></span>
                <span class="newsCtn_b">
