...
<template>
  <div class="newlists" id="newlists">
        <ul class="nlist">
            <li v-for="(value, key) in newList" v-if="(key == 5)">
        ...
        <ul class="nlist">
            <li v-for="(value, key) in newList" v-if="(key == 3)">
               <span class="nimg_b"><img :src="require('./../components/img/ban/l/' + value.Image +'.jpg')"></span>
                <router-link :to="{ name: 'newsMore1', params: { articid: value.Id , page: num, content: value.Content}}">
        ...
        <ul class="nlist">
            <li v-for="(value, key) in newList" v-if="(key > 5)">
                <router-link :to="{ name: 'newsMore1', params: { articid: value.Id , page: num, content: value.Content}}">
                <span class="nimg"><img :src="require('./../components/img/ban/l/' + value.Image +'.jpg')"></span>
                <span class="newsCtn">
